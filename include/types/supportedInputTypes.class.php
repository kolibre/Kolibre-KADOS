...
class supportedInputTypes extends AbstractType {

    /**
     * @var array[0, unbounded] of (object)input
     */
    public $input;
    ...
    /**
     * constructor for class supportedInputTypes
     */
    ...
    /**
     * validator for class supportedInputTypes
     */
    function validate() {
        // input must occur zero or more times
