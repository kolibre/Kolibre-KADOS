...
class DaisyOnlineServiceOperationNotSupportedTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testUpdateBookmarks()
    {
        ...
        $this->assertTrue($this->callOperation('updateBookmarks', $input, 'operationNotSupportedFault'));
    }
    ...
    public function testAddContentToBookshelf()
    {
        ...
        $this->assertTrue($this->callOperation('addContentToBookshelf', $input, 'operationNotSupportedFault'));
    }
    ...
    public function testGetUserCredentials()
    {
        ...
        $this->assertTrue($this->callOperation('getUserCredentials', $input, 'operationNotSupportedFault'));
    }
    ...
    public function testGetTermsOfService()
    {
        ...
        $this->assertTrue($this->callOperation('getTermsOfService', $input, 'operationNotSupportedFault'));
    }
    ...
    public function testAcceptTermsOfService()
    {
        ...
        $this->assertTrue($this->callOperation('acceptTermsOfService', $input, 'operationNotSupportedFault'));
    }
    ...
    public function testSetProgressState()
    {
        ...
        $this->assertTrue($this->callOperation('setProgressState', $input, 'operationNotSupportedFault'));
    }
}
